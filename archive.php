...
?>
    <!-- Blog-home : starts -->
      ...
      <div class="blog-home-overlay" style="background:rgba(0,0,0,0.5)">
          <h1><?php
            if ( is_day() ) :
              printf( __( 'Daily Archives: %s', 'hymazelang' ), get_the_date() );

            elseif ( is_month() ) :
              printf( __( 'Monthly Archives: %s', 'hymazelang' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'hymazelang' ) ) );

            elseif ( is_year() ) :
              printf( __( 'Yearly Archives: %s', 'hymazelang' ), get_the_date( _x( 'Y', 'yearly archives date format', 'hymazelang' ) ) );

            else :
              _e( 'Archives', 'hymazelang' );
